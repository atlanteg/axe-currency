// Автогенерировано из Android strings.xml (tools/gen-i18n.py)
const I18N = {
"en": {
"app_name": "FIXXE",
"ok": "Got it",
...
"loading": "Loading…",
"updated": "Updated %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Network error",
"clear": "CLEAR",
"add_currency": "＋ Add currency",
"mid_market": "Mid-market rates ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "ver. %1$s",
"base_currency": "Base currency",
"delete_currency_title": "Remove currency?",
"delete_currency_msg": "Remove %1$s — %2$s from the list?",
"add_currency_title": "Choose from %1$d available currencies",
"search_hint": "Code or name…",
...
"update_msg": "Version %1$s is available. Download and install?",
"update_now": "Update",
"update_later": "Later",
"downloading": "Downloading…",
"settings": "Settings",
"setting_precision": "Display precision:  %1$s",
"setting_source": "Rate source:  %1$s",
"setting_language": "🌐 Language:  %1$s",
"precision_title": "Display precision",
"prec_0": "0 — integers",
"prec_1": "1 decimal",
"prec_2": "2 decimals",
"prec_4": "4 decimals",
"precision_value_int": "integers",
"precision_value_n": "%1$d dec.",
"source_title": "Rate source",
"source_auto": "Auto (with fallback)",
...
"updated": "تم التحديث %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "خطأ في الشبكة",
"clear": "مسح",
"add_currency": "＋ إضافة عملة",
"mid_market": "أسعار السوق الوسطية ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "الإصدار %1$s",
"base_currency": "العملة الأساسية",
"delete_currency_title": "إزالة العملة؟",
"delete_currency_msg": "إزالة %1$s — %2$s من القائمة؟",
"add_currency_title": "اختر من بين %1$d عملة متاحة",
"search_hint": "الرمز أو الاسم…",
"update_title": "يتوفر تحديث",
"update_msg": "الإصدار %1$s متاح. تنزيل وتثبيت؟",
"update_now": "تحديث",
"update_later": "لاحقاً",
"downloading": "جارٍ التنزيل…",
"settings": "الإعدادات",
"setting_precision": "دقة العرض:  %1$s",
"setting_source": "مصدر السعر:  %1$s",
"setting_language": "🌐 اللغة:  %1$s",
"precision_title": "دقة العرض",
"prec_0": "0 — أعداد صحيحة",
"prec_1": "خانة عشرية واحدة",
"prec_2": "خانتان عشريتان",
"prec_4": "4 خانات عشرية",
"precision_value_int": "أعداد صحيحة",
"precision_value_n": "%1$d خانة",
"source_title": "مصدر السعر",
"source_auto": "تلقائي (مع بديل احتياطي)",
"language_title": "اللغة",
"language_system": "افتراضي النظام",
"source_info_title": "مصدر السعر",
"source_info_message": "سعر السوق الوسطي — نقطة المنتصف بين الشراء والبيع في السوق العالمية.\n\nالعملة الأساسية: EUR، وتُحسب الأزواج الأخرى عبر اليورو.\n\nالمصادر (بديل احتياطي تلقائي):\n1. ExchangeRate-API — الأساسي\n2. F.A. — إذا تعطّل الأساسي\n3. Frankfurter (ECB) — البديل الثاني\n\nإذا لم يستجب المصدر الأساسي أثناء التحديث التلقائي أو عند ↻، يأخذ التطبيق البيانات تلقائياً من المصدر التالي. يظهر المصدر الحالي في الأعلى بجوار وقت التحديث.\n\nفي الإعدادات (⚙) يمكنك فرض مصدر محدد — وتبقى المصادر الأخرى كبديل احتياطي.\n\nيُحدَّث مرة واحدة يومياً. الفرق عن خدمات مرجعية أخرى عادةً أقل من 0.5% — هذه أسعار مرجعية وليست عروضاً لحظية.\n\nالتراخيص والإسناد:\n• ExchangeRate-API — يتطلب رابط “Rates By Exchange Rate API” (في التذييل، قابل للنقر).\n• F.A. — CC0 (ملكية عامة)، لا يتطلب إسناداً.\n• Frankfurter — MIT، بيانات من البنك المركزي الأوروبي (ECB).",
"filter_all": "الكل",
...
"selected": "נבחרו: %1$d",
"loading": "טוען…",
"updated": "עודכן %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "שגיאת רשת",
"clear": "נקה",
"add_currency": "＋ הוספת מטבע",
"mid_market": "שערי אמצע-שוק ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "גרסה %1$s",
"base_currency": "מטבע בסיס",
"delete_currency_title": "להסיר מטבע?",
"delete_currency_msg": "להסיר את %1$s — %2$s מהרשימה?",
"add_currency_title": "בחר מתוך %1$d מטבעות זמינים",
"search_hint": "קוד או שם…",
"update_title": "עדכון זמין",
"update_msg": "גרסה %1$s זמינה. להוריד ולהתקין?",
"update_now": "עדכון",
"update_later": "מאוחר יותר",
"downloading": "מוריד…",
"settings": "הגדרות",
"setting_precision": "דיוק תצוגה:  %1$s",
"setting_source": "מקור שער:  %1$s",
"setting_language": "🌐 שפה:  %1$s",
"precision_title": "דיוק תצוגה",
"prec_0": "0 — מספרים שלמים",
"prec_1": "ספרה עשרונית אחת",
"prec_2": "2 ספרות עשרוניות",
"prec_4": "4 ספרות עשרוניות",
"precision_value_int": "מספרים שלמים",
"precision_value_n": "%1$d ספרות",
"source_title": "מקור שער",
"source_auto": "אוטומטי (עם גיבוי)",
"language_title": "שפה",
"language_system": "ברירת מחדל של המערכת",
"source_info_title": "מקור שער",
"source_info_message": "שער אמצע-שוק — נקודת האמצע בין קנייה למכירה בשוק העולמי.\n\nמטבע בסיס: EUR, שאר הצמדים מחושבים דרך האירו.\n\nמקורות (גיבוי אוטומטי):\n1. ExchangeRate-API — ראשי\n2. F.A. — אם הראשי אינו זמין\n3. Frankfurter (ECB) — גיבוי שני\n\nאם המקור הראשי אינו מגיב בעת עדכון אוטומטי או בלחיצה על ↻, האפליקציה לוקחת אוטומטית נתונים מהמקור הבא. המקור הנוכחי מוצג למעלה ליד זמן העדכון.\n\nבהגדרות (⚙) אפשר לכפות מקור מסוים — האחרים עדיין נשארים כגיבוי.\n\nמתעדכן פעם ביום. ההפרש משירותי ייחוס אחרים הוא בדרך כלל מתחת ל-0.5% — אלה שערי ייחוס, לא ציטוטים בזמן אמת.\n\nרישיונות וייחוס:\n• ExchangeRate-API — דורש את הקישור “Rates By Exchange Rate API” (בכותרת התחתונה, ניתן ללחיצה).\n• F.A. — CC0 (נחלת הכלל), אינו דורש ייחוס.\n• Frankfurter — MIT, נתונים מהבנק המרכזי האירופי (ECB).",
"filter_all": "הכול",
...
"close": "Затвори",
"delete": "Изтрий",
"selected": "Избрани: %1$d",
"loading": "Зареждане…",
"updated": "Обновено %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Мрежова грешка",
"clear": "ИЗЧИСТИ",
"add_currency": "＋ Добави валута",
"mid_market": "Средни пазарни курсове ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "вер. %1$s",
"base_currency": "Основна валута",
"delete_currency_title": "Премахване на валута?",
"delete_currency_msg": "Да премахна ли %1$s — %2$s от списъка?",
"add_currency_title": "Изберете от %1$d налични валути",
"search_hint": "Код или име…",
"update_title": "Налична е актуализация",
"update_msg": "Налична е версия %1$s. Да изтегля и инсталирам ли?",
"update_now": "Актуализирай",
"update_later": "По-късно",
"downloading": "Изтегляне…",
"settings": "Настройки",
"setting_precision": "Точност на показване:  %1$s",
"setting_source": "Източник на курсове:  %1$s",
"setting_language": "🌐 Език:  %1$s",
"precision_title": "Точност на показване",
"prec_0": "0 — цели числа",
"prec_1": "1 знак",
"prec_2": "2 знака",
"prec_4": "4 знака",
"precision_value_int": "цели числа",
"precision_value_n": "%1$d зн.",
"source_title": "Източник на курсове",
"source_auto": "Автоматично (с резерва)",
"language_title": "Език",
"language_system": "Системен по подразбиране",
"source_info_title": "Източник на курсове",
"source_info_message": "Среден пазарен курс — средата между курса купува и продава на световния пазар.\n\nОсновна валута: EUR, останалите двойки се изчисляват през еврото.\n\nИзточници (автоматична резерва):\n1. ExchangeRate-API — основен\n2. F.A. — ако основният не работи\n3. Frankfurter (ECB) — втора резерва\n\nАко основният източник не отговори при автоматично обновяване или при ↻, приложението автоматично взема данни от следващия. Текущият източник е показан горе до времето на обновяване.\n\nВ настройките (⚙) можете да наложите конкретен източник — останалите пак остават като резерва.\n\nОбновява се веднъж на ден. Разликата спрямо други референтни услуги обикновено е под 0.5% — това са референтни курсове, а не котировки в реално време.\n\nЛицензи и признание:\n• ExchangeRate-API — изисква връзка “Rates By Exchange Rate API” (в долния колонтитул, кликваема).\n• F.A. — CC0 (обществено достояние), не се изисква признание.\n• Frankfurter — MIT, данни от Европейската централна банка (ECB).",
"filter_all": "Всички",
...
"close": "Zatvori",
"delete": "Izbriši",
"selected": "Odabrano: %1$d",
"loading": "Učitavanje…",
"updated": "Ažurirano %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Greška mreže",
"clear": "OČISTI",
"add_currency": "＋ Dodaj valutu",
"mid_market": "Srednji tržišni kursevi ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "ver. %1$s",
"base_currency": "Osnovna valuta",
"delete_currency_title": "Ukloniti valutu?",
"delete_currency_msg": "Ukloniti %1$s — %2$s sa liste?",
"add_currency_title": "Odaberite od %1$d dostupnih valuta",
"search_hint": "Kôd ili naziv…",
"update_title": "Dostupno ažuriranje",
"update_msg": "Verzija %1$s je dostupna. Preuzeti i instalirati?",
"update_now": "Ažuriraj",
"update_later": "Kasnije",
"downloading": "Preuzimanje…",
"settings": "Postavke",
"setting_precision": "Prikazana preciznost:  %1$s",
"setting_source": "Izvor kursa:  %1$s",
"setting_language": "🌐 Jezik:  %1$s",
"precision_title": "Prikazana preciznost",
"prec_0": "0 — cijeli brojevi",
"prec_1": "1 decimala",
"prec_2": "2 decimale",
"prec_4": "4 decimale",
"precision_value_int": "cijeli brojevi",
"precision_value_n": "%1$d dec.",
"source_title": "Izvor kursa",
"source_auto": "Automatski (sa rezervom)",
"language_title": "Jezik",
"language_system": "Zadano sistemom",
"source_info_title": "Izvor kursa",
"source_info_message": "Srednji tržišni kurs — sredina između kupovnog i prodajnog na globalnom tržištu.\n\nOsnovna valuta: EUR, ostali parovi se računaju preko eura.\n\nIzvori (automatska rezerva):\n1. ExchangeRate-API — primarni\n2. F.A. — ako primarni ne radi\n3. Frankfurter (ECB) — druga rezerva\n\nAko primarni izvor ne odgovori tokom automatskog ažuriranja ili na ↻, aplikacija automatski uzima podatke od sljedećeg. Trenutni izvor je prikazan na vrhu pored vremena ažuriranja.\n\nU Postavkama (⚙) možete nametnuti određeni izvor — ostali i dalje ostaju kao rezerva.\n\nAžurira se jednom dnevno. Razlika u odnosu na druge referentne servise je obično manja od 0.5% — to su referentni kursevi, a ne kotacije u stvarnom vremenu.\n\nLicence i atribucija:\n• ExchangeRate-API — zahtijeva link „Rates By Exchange Rate API“ (u podnožju, klikabilan).\n• F.A. — CC0 (javno vlasništvo), bez obavezne atribucije.\n• Frankfurter — MIT, podaci iz Evropske centralne banke (ECB).",
"filter_all": "Sve",
...
"close": "Sulge",
"delete": "Kustuta",
"selected": "Valitud: %1$d",
"loading": "Laadimine…",
"updated": "Uuendatud %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Võrguviga",
"clear": "TÜHJENDA",
"add_currency": "＋ Lisa valuuta",
"mid_market": "Keskturu kursid ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "ver. %1$s",
"base_currency": "Baasvaluuta",
"delete_currency_title": "Eemalda valuuta?",
"delete_currency_msg": "Eemalda %1$s — %2$s loendist?",
"add_currency_title": "Vali %1$d saadaoleva valuuta seast",
"search_hint": "Kood või nimi…",
"update_title": "Saadaval on uuendus",
"update_msg": "Versioon %1$s on saadaval. Laadida alla ja paigaldada?",
"update_now": "Uuenda",
"update_later": "Hiljem",
"downloading": "Allalaadimine…",
"settings": "Seaded",
"setting_precision": "Kuvamistäpsus:  %1$s",
"setting_source": "Kursi allikas:  %1$s",
"setting_language": "🌐 Keel:  %1$s",
"precision_title": "Kuvamistäpsus",
"prec_0": "0 — täisarvud",
"prec_1": "1 kümnendkoht",
"prec_2": "2 kümnendkohta",
"prec_4": "4 kümnendkohta",
"precision_value_int": "täisarvud",
"precision_value_n": "%1$d koht.",
"source_title": "Kursi allikas",
"source_auto": "Automaatne (varuallikaga)",
"language_title": "Keel",
"language_system": "Süsteemi vaikeväärtus",
"source_info_title": "Kursi allikas",
"source_info_message": "Keskturu kurss — keskpunkt ostu- ja müügikursi vahel maailmaturul.\n\nBaasvaluuta: EUR, teised paarid arvutatakse euro kaudu.\n\nAllikad (automaatne varuvariant):\n1. ExchangeRate-API — peamine\n2. F.A. — kui peamine ei tööta\n3. Frankfurter (ECB) — teine varuvariant\n\nKui peamine allikas ei vasta automaatse uuendamise ajal või ↻ vajutamisel, võtab rakendus andmed automaatselt järgmisest. Praegune allikas kuvatakse üleval uuendamisaja kõrval.\n\nSeadetes (⚙) saad sundida kindla allika — teised jäävad ikkagi varuvariandiks.\n\nUuendatakse kord päevas. Erinevus teistest viiteteenustest on tavaliselt alla 0.5% — need on viitekursid, mitte reaalajas noteeringud.\n\nLitsentsid ja viited:\n• ExchangeRate-API — nõuab linki “Rates By Exchange Rate API” (jaluses, klõpsatav).\n• F.A. — CC0 (public domain), viidet pole vaja.\n• Frankfurter — MIT, andmed European Central Bank (ECB).",
"filter_all": "Kõik",
...
"clear": "OČISTI",
"add_currency": "＋ Dodaj valutu",
"mid_market": "Srednji tržišni tečajevi ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "ver. %1$s",
"base_currency": "Osnovna valuta",
"delete_currency_title": "Ukloniti valutu?",
"delete_currency_msg": "Ukloniti %1$s — %2$s s popisa?",
"add_currency_title": "Odaberite od %1$d dostupnih valuta",
"search_hint": "Kôd ili naziv…",
"update_title": "Dostupno ažuriranje",
"update_msg": "Verzija %1$s je dostupna. Preuzeti i instalirati?",
...
"settings": "Postavke",
"setting_precision": "Prikazana preciznost:  %1$s",
"setting_source": "Izvor tečaja:  %1$s",
"setting_language": "🌐 Jezik:  %1$s",
"precision_title": "Prikazana preciznost",
"prec_0": "0 — cijeli brojevi",
"prec_1": "1 decimala",
...
"close": "Bezárás",
"delete": "Törlés",
"selected": "Kijelölve: %1$d",
"loading": "Betöltés…",
"updated": "Frissítve %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Hálózati hiba",
"clear": "TÖRLÉS",
"add_currency": "＋ Pénznem hozzáadása",
"mid_market": "Középárfolyamok ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "verzió %1$s",
"base_currency": "Alappénznem",
"delete_currency_title": "Pénznem eltávolítása?",
"delete_currency_msg": "Eltávolítja a(z) %1$s — %2$s elemet a listából?",
"add_currency_title": "Válasszon a(z) %1$d elérhető pénznem közül",
"search_hint": "Kód vagy név…",
"update_title": "Frissítés érhető el",
"update_msg": "A(z) %1$s verzió elérhető. Letölti és telepíti?",
"update_now": "Frissítés",
"update_later": "Később",
"downloading": "Letöltés…",
"settings": "Beállítások",
"setting_precision": "Megjelenítési pontosság:  %1$s",
"setting_source": "Árfolyamforrás:  %1$s",
"setting_language": "🌐 Nyelv:  %1$s",
"precision_title": "Megjelenítési pontosság",
"prec_0": "0 — egész számok",
"prec_1": "1 tizedesjegy",
"prec_2": "2 tizedesjegy",
"prec_4": "4 tizedesjegy",
"precision_value_int": "egész számok",
"precision_value_n": "%1$d tiz.",
"source_title": "Árfolyamforrás",
"source_auto": "Automatikus (tartalékkal)",
"language_title": "Nyelv",
"language_system": "Rendszer alapértelmezése",
"source_info_title": "Árfolyamforrás",
"source_info_message": "Középárfolyam — a vételi és eladási ár közötti középpont a globális piacon.\n\nAlappénznem: EUR, a többi párt az eurón keresztül számítjuk.\n\nForrások (automatikus tartalék):\n1. ExchangeRate-API — elsődleges\n2. F.A. — ha az elsődleges nem elérhető\n3. Frankfurter (ECB) — második tartalék\n\nHa az elsődleges forrás nem válaszol az automatikus frissítés során vagy a ↻ gombra, az alkalmazás automatikusan a következőből veszi az adatokat. Az aktuális forrás felül látható a frissítés ideje mellett.\n\nA Beállításokban (⚙) kényszeríthet egy adott forrást — a többi továbbra is tartalékként marad.\n\nNaponta egyszer frissül. A más referenciaszolgáltatásoktól való eltérés általában 0.5% alatt van — ezek referenciaárfolyamok, nem valós idejű jegyzések.\n\nLicencek és forrásmegjelölés:\n• ExchangeRate-API — megköveteli a “Rates By Exchange Rate API” hivatkozást (a láblécben, kattintható).\n• F.A. — CC0 (közkincs), forrásmegjelölés nem szükséges.\n• Frankfurter — MIT, adatok a European Central Bank (ECB) forrásból.",
"filter_all": "Mind",
...
"version": "ver. %1$s",
"base_currency": "基準通貨",
"delete_currency_title": "通貨を削除しますか？",
"delete_currency_msg": "%1$s — %2$s をリストから削除しますか？",
"add_currency_title": "%1$d 種類の利用可能な通貨から選択",
"search_hint": "コードまたは名称…",
"update_title": "アップデートあり",
"update_msg": "バージョン %1$s が利用可能です。ダウンロードしてインストールしますか？",
"update_now": "更新",
"update_later": "後で",
"downloading": "ダウンロード中…",
"settings": "設定",
"setting_precision": "表示精度:  %1$s",
"setting_source": "レートソース:  %1$s",
"setting_language": "🌐 言語:  %1$s",
"precision_title": "表示精度",
"prec_0": "0 — 整数",
"prec_1": "小数1桁",
"prec_2": "小数2桁",
"prec_4": "小数4桁",
"precision_value_int": "整数",
"precision_value_n": "小数%1$d桁",
"source_title": "レートソース",
"source_auto": "自動（フォールバック付き）",
"language_title": "言語",
"language_system": "システムのデフォルト",
"source_info_title": "レートソース",
"source_info_message": "仲値レート — 世界市場での買値と売値の中間値です。\n\n基準通貨: EUR、その他のペアはユーロを介して計算されます。\n\nソース（自動フォールバック）:\n1. ExchangeRate-API — 主要\n2. F.A. — 主要ソースが停止した場合\n3. Frankfurter (ECB) — 第2フォールバック\n\n自動更新時または ↻ 押下時に主要ソースが応答しない場合、アプリは自動的に次のソースからデータを取得します。現在のソースは更新時刻の隣に上部に表示されます。\n\n設定（⚙）で特定のソースを強制指定できます — 他のソースは引き続きフォールバックとして残ります。\n\n更新は1日1回です。他の参考レートサービスとの差は通常 0.5% 未満です — これはリアルタイムの相場ではなく参考レートです。\n\nライセンスと表記:\n• ExchangeRate-API —「Rates By Exchange Rate API」リンクが必要です（フッター内、クリック可能）。\n• F.A. — CC0（パブリックドメイン）、表記は不要です。\n• Frankfurter — MIT、データは欧州中央銀行 (ECB) から提供されています。",
"filter_all": "すべて",
...
"close": "დახურვა",
"delete": "წაშლა",
"selected": "არჩეული: %1$d",
"loading": "იტვირთება…",
"updated": "განახლდა %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "ქსელის შეცდომა",
"clear": "გასუფთავება",
"add_currency": "＋ ვალუტის დამატება",
"mid_market": "საშუალო საბაზრო კურსები ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "ვერს. %1$s",
"base_currency": "საბაზისო ვალუტა",
"delete_currency_title": "ვალუტის ამოშლა?",
"delete_currency_msg": "ამოვშალოთ %1$s — %2$s სიიდან?",
"add_currency_title": "აირჩიეთ %1$d ხელმისაწვდომ ვალუტიდან",
"search_hint": "კოდი ან სახელი…",
"update_title": "ხელმისაწვდომია განახლება",
"update_msg": "ხელმისაწვდომია ვერსია %1$s. ჩამოვტვირთოთ და დავაინსტალიროთ?",
"update_now": "განახლება",
"update_later": "მოგვიანებით",
"downloading": "იტვირთება…",
"settings": "პარამეტრები",
"setting_precision": "ჩვენების სიზუსტე:  %1$s",
"setting_source": "კურსების წყარო:  %1$s",
"setting_language": "🌐 ენა:  %1$s",
"precision_title": "ჩვენების სიზუსტე",
"prec_0": "0 — მთელი რიცხვები",
"prec_1": "1 ათწილადი",
"prec_2": "2 ათწილადი",
"prec_4": "4 ათწილადი",
"precision_value_int": "მთელი რიცხვები",
"precision_value_n": "%1$d ათწ.",
"source_title": "კურსების წყარო",
"source_auto": "ავტო (სარეზერვოთი)",
"language_title": "ენა",
"language_system": "სისტემის ნაგულისხმევი",
"source_info_title": "კურსების წყარო",
"source_info_message": "საშუალო საბაზრო კურსი — შუა წერტილი ყიდვასა და გაყიდვას შორის მსოფლიო ბაზარზე.\n\nსაბაზისო ვალუტა: EUR, დანარჩენი წყვილები გამოითვლება ევროს გავლით.\n\nწყაროები (ავტომატური სარეზერვო):\n1. ExchangeRate-API — ძირითადი\n2. F.A. — თუ ძირითადი მიუწვდომელია\n3. Frankfurter (ECB) — მეორე სარეზერვო\n\nთუ ძირითადი წყარო არ პასუხობს ავტოგანახლებისას ან ↻-ზე, აპლიკაცია ავტომატურად იღებს მონაცემებს შემდეგიდან. მიმდინარე წყარო ნაჩვენებია ზემოთ, განახლების დროის გვერდით.\n\nპარამეტრებში (⚙) შეგიძლიათ იძულებით აირჩიოთ კონკრეტული წყარო — დანარჩენები მაინც დარჩება სარეზერვოდ.\n\nახლდება დღეში ერთხელ. სხვაობა სხვა საცნობარო სერვისებთან ჩვეულებრივ 0.5%-ზე ნაკლებია — ეს საცნობარო კურსებია, არა რეალურ დროში კოტირებები.\n\nლიცენზიები და მითითება:\n• ExchangeRate-API — მოითხოვს ბმულს “Rates By Exchange Rate API” (ქვედა კოლონტიტულში, დაწკაპუნებადი).\n• F.A. — CC0 (საზოგადოებრივი საკუთრება), მითითება არ არის საჭირო.\n• Frankfurter — MIT, მონაცემები ევროპის ცენტრალური ბანკიდან (ECB).",
"filter_all": "ყველა",
...
"version": "버전 %1$s",
"base_currency": "기준 통화",
"delete_currency_title": "통화를 삭제할까요?",
"delete_currency_msg": "목록에서 %1$s — %2$s 을(를) 삭제할까요?",
"add_currency_title": "사용 가능한 %1$d개 통화 중 선택",
"search_hint": "코드 또는 이름…",
"update_title": "업데이트 사용 가능",
"update_msg": "버전 %1$s 을(를) 사용할 수 있습니다. 다운로드하여 설치할까요?",
"update_now": "업데이트",
"update_later": "나중에",
"downloading": "다운로드 중…",
"settings": "설정",
"setting_precision": "표시 정밀도:  %1$s",
"setting_source": "환율 출처:  %1$s",
"setting_language": "🌐 언어:  %1$s",
"precision_title": "표시 정밀도",
"prec_0": "0 — 정수",
"prec_1": "소수점 1자리",
"prec_2": "소수점 2자리",
"prec_4": "소수점 4자리",
"precision_value_int": "정수",
"precision_value_n": "소수점 %1$d자리",
"source_title": "환율 출처",
"source_auto": "자동 (대체 포함)",
"language_title": "언어",
"language_system": "시스템 기본값",
"source_info_title": "환율 출처",
"source_info_message": "중간 시장 환율 — 글로벌 시장의 매수와 매도 사이의 중간값입니다.\n\n기준 통화: EUR, 다른 통화쌍은 유로를 통해 계산됩니다.\n\n출처(자동 대체):\n1. ExchangeRate-API — 기본\n2. F.A. — 기본 출처가 다운된 경우\n3. Frankfurter (ECB) — 두 번째 대체\n\n자동 업데이트 시 또는 ↻ 를 누를 때 기본 출처가 응답하지 않으면 앱이 자동으로 다음 출처에서 데이터를 가져옵니다. 현재 출처는 업데이트 시간 옆 상단에 표시됩니다.\n\n설정(⚙)에서 특정 출처를 강제로 지정할 수 있습니다 — 나머지는 여전히 대체로 남아 있습니다.\n\n하루에 한 번 업데이트됩니다. 다른 참고 환율 서비스와의 차이는 보통 0.5% 미만입니다 — 이는 실시간 시세가 아닌 참고 환율입니다.\n\n라이선스 및 출처 표기:\n• ExchangeRate-API —“Rates By Exchange Rate API” 링크가 필요합니다(하단 바닥글, 클릭 가능).\n• F.A. — CC0(퍼블릭 도메인), 표기 불필요.\n• Frankfurter — MIT, 데이터는 유럽 중앙은행(ECB)에서 제공됩니다.",
"filter_all": "전체",
...
"close": "Uždaryti",
"delete": "Ištrinti",
"selected": "Pasirinkta: %1$d",
"loading": "Įkeliama…",
"updated": "Atnaujinta %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Tinklo klaida",
"clear": "IŠVALYTI",
"add_currency": "＋ Pridėti valiutą",
"mid_market": "Vidurinės rinkos kursai ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "ver. %1$s",
"base_currency": "Bazinė valiuta",
"delete_currency_title": "Pašalinti valiutą?",
"delete_currency_msg": "Pašalinti %1$s — %2$s iš sąrašo?",
"add_currency_title": "Pasirinkite iš %1$d galimų valiutų",
"search_hint": "Kodas arba pavadinimas…",
"update_title": "Yra atnaujinimas",
"update_msg": "Prieinama versija %1$s. Atsisiųsti ir įdiegti?",
"update_now": "Atnaujinti",
"update_later": "Vėliau",
"downloading": "Atsisiunčiama…",
"settings": "Nustatymai",
"setting_precision": "Rodymo tikslumas:  %1$s",
"setting_source": "Kursų šaltinis:  %1$s",
"setting_language": "🌐 Kalba:  %1$s",
"precision_title": "Rodymo tikslumas",
"prec_0": "0 — sveikieji skaičiai",
"prec_1": "1 skaitmuo po kablelio",
"prec_2": "2 skaitmenys po kablelio",
"prec_4": "4 skaitmenys po kablelio",
"precision_value_int": "sveikieji skaičiai",
"precision_value_n": "%1$d skaitm.",
"source_title": "Kursų šaltinis",
"source_auto": "Automatinis (su atsargine)",
"language_title": "Kalba",
"language_system": "Sistemos numatytoji",
"source_info_title": "Kursų šaltinis",
"source_info_message": "Vidurinės rinkos kursas — vidurio taškas tarp pirkimo ir pardavimo pasaulinėje rinkoje.\n\nBazinė valiuta: EUR, kitos poros skaičiuojamos per eurą.\n\nŠaltiniai (automatinis perjungimas):\n1. ExchangeRate-API — pirminis\n2. F.A. — jei pirminis neveikia\n3. Frankfurter (ECB) — antras atsarginis\n\nJei pirminis šaltinis neatsako automatinio atnaujinimo metu arba paspaudus ↻, programa automatiškai paima duomenis iš kito. Dabartinis šaltinis rodomas viršuje šalia atnaujinimo laiko.\n\nNustatymuose (⚙) galite priverstinai nustatyti konkretų šaltinį — kiti vis tiek lieka kaip atsarginiai.\n\nAtnaujinama kartą per dieną. Skirtumas nuo kitų orientacinių paslaugų paprastai yra mažesnis nei 0.5% — tai orientaciniai kursai, o ne realaus laiko kotiruotės.\n\nLicencijos ir priskyrimas:\n• ExchangeRate-API — reikalauja nuorodos “Rates By Exchange Rate API” (poraštėje, spustelimos).\n• F.A. — CC0 (public domain), priskyrimo nereikia.\n• Frankfurter — MIT, duomenys iš European Central Bank (ECB).",
"filter_all": "Visi",
...
"close": "Aizvērt",
"delete": "Dzēst",
"selected": "Atlasīts: %1$d",
"loading": "Ielādē…",
"updated": "Atjaunināts %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Tīkla kļūda",
"clear": "NOTĪRĪT",
"add_currency": "＋ Pievienot valūtu",
"mid_market": "Vidējā tirgus kursi ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "ver. %1$s",
"base_currency": "Bāzes valūta",
"delete_currency_title": "Noņemt valūtu?",
"delete_currency_msg": "Noņemt %1$s — %2$s no saraksta?",
"add_currency_title": "Izvēlieties no %1$d pieejamajām valūtām",
"search_hint": "Kods vai nosaukums…",
"update_title": "Pieejams atjauninājums",
"update_msg": "Ir pieejama versija %1$s. Lejupielādēt un instalēt?",
"update_now": "Atjaunināt",
"update_later": "Vēlāk",
"downloading": "Lejupielādē…",
"settings": "Iestatījumi",
"setting_precision": "Attēlošanas precizitāte:  %1$s",
"setting_source": "Kursu avots:  %1$s",
"setting_language": "🌐 Valoda:  %1$s",
"precision_title": "Attēlošanas precizitāte",
"prec_0": "0 — veseli skaitļi",
"prec_1": "1 cipars aiz komata",
"prec_2": "2 cipari aiz komata",
"prec_4": "4 cipari aiz komata",
"precision_value_int": "veseli skaitļi",
"precision_value_n": "%1$d cip.",
"source_title": "Kursu avots",
"source_auto": "Automātiski (ar rezerves avotu)",
"language_title": "Valoda",
"language_system": "Sistēmas noklusējums",
"source_info_title": "Kursu avots",
"source_info_message": "Vidējā tirgus kurss — viduspunkts starp pirkšanas un pārdošanas kursu pasaules tirgū.\n\nBāzes valūta: EUR, citi pāri tiek aprēķināti caur eiro.\n\nAvoti (automātiska pārslēgšanās):\n1. ExchangeRate-API — primārais\n2. F.A. — ja primārais nedarbojas\n3. Frankfurter (ECB) — otrais rezerves\n\nJa primārais avots neatbild automātiskās atjaunināšanas laikā vai nospiežot ↻, lietotne automātiski ņem datus no nākamā. Pašreizējais avots ir redzams augšpusē blakus atjaunināšanas laikam.\n\nIestatījumos (⚙) varat piespiedu kārtā izvēlēties konkrētu avotu — pārējie joprojām paliek kā rezerve.\n\nAtjaunina reizi dienā. Atšķirība no citiem atsauces pakalpojumiem parasti ir mazāka par 0.5% — tie ir atsauces kursi, nevis reāllaika kotējumi.\n\nLicences un atsauces:\n• ExchangeRate-API — nepieciešama saite “Rates By Exchange Rate API” (kājenē, noklikšķināma).\n• F.A. — CC0 (public domain), atsauce nav nepieciešama.\n• Frankfurter — MIT, dati no European Central Bank (ECB).",
"filter_all": "Visi",
...
"close": "Затвори",
"delete": "Избриши",
"selected": "Избрано: %1$d",
"loading": "Се вчитува…",
"updated": "Ажурирано %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Мрежна грешка",
"clear": "ИСЧИСТИ",
"add_currency": "＋ Додај валута",
"mid_market": "Средни пазарни курсеви ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "верз. %1$s",
"base_currency": "Основна валута",
"delete_currency_title": "Да се отстрани валутата?",
"delete_currency_msg": "Да се отстрани %1$s — %2$s од списокот?",
"add_currency_title": "Изберете од %1$d достапни валути",
"search_hint": "Код или име…",
"update_title": "Достапно ажурирање",
"update_msg": "Верзијата %1$s е достапна. Да се преземе и инсталира?",
"update_now": "Ажурирај",
"update_later": "Подоцна",
"downloading": "Се презема…",
"settings": "Поставки",
"setting_precision": "Прикажана прецизност:  %1$s",
"setting_source": "Извор на курс:  %1$s",
"setting_language": "🌐 Јазик:  %1$s",
"precision_title": "Прикажана прецизност",
"prec_0": "0 — цели броеви",
"prec_1": "1 децимала",
"prec_2": "2 децимали",
"prec_4": "4 децимали",
"precision_value_int": "цели броеви",
"precision_value_n": "%1$d дец.",
"source_title": "Извор на курс",
"source_auto": "Автоматски (со резерва)",
"language_title": "Јазик",
"language_system": "Системски стандард",
"source_info_title": "Извор на курс",
"source_info_message": "Среден пазарен курс — средината помеѓу куповниот и продажниот на глобалниот пазар.\n\nОсновна валута: EUR, другите парови се пресметуваат преку еврото.\n\nИзвори (автоматска резерва):\n1. ExchangeRate-API — примарен\n2. F.A. — ако примарниот не работи\n3. Frankfurter (ECB) — втора резерва\n\nАко примарниот извор не одговори за време на автоматското ажурирање или на ↻, апликацијата автоматски зема податоци од следниот. Тековниот извор е прикажан на врвот покрај времето на ажурирање.\n\nВо Поставки (⚙) може да наметнете одреден извор — другите сепак остануваат како резерва.\n\nСе ажурира еднаш дневно. Разликата во однос на други референтни сервиси обично е помала од 0.5% — тоа се референтни курсеви, а не котации во реално време.\n\nЛиценци и атрибуција:\n• ExchangeRate-API — бара линк „Rates By Exchange Rate API“ (во подножјето, кликабилен).\n• F.A. — CC0 (јавна сопственост), без задолжителна атрибуција.\n• Frankfurter — MIT, податоци од Европската централна банка (ECB).",
"filter_all": "Сите",
...
"version": "ver. %1$s",
"base_currency": "Basisvaluta",
"delete_currency_title": "Fjerne valuta?",
"delete_currency_msg": "Fjerne %1$s — %2$s fra listen?",
"add_currency_title": "Velg blant %1$d tilgjengelige valutaer",
"search_hint": "Kode eller navn…",
"update_title": "Oppdatering tilgjengelig",
"update_msg": "Versjon %1$s er tilgjengelig. Laste ned og installere?",
"update_now": "Oppdater",
"update_later": "Senere",
"downloading": "Laster ned…",
"settings": "Innstillinger",
"setting_precision": "Visningspresisjon:  %1$s",
"setting_source": "Kurskilde:  %1$s",
"setting_language": "🌐 Språk:  %1$s",
"precision_title": "Visningspresisjon",
"prec_0": "0 — heltall",
"prec_1": "1 desimal",
"prec_2": "2 desimaler",
"prec_4": "4 desimaler",
"precision_value_int": "heltall",
"precision_value_n": "%1$d des.",
"source_title": "Kurskilde",
"source_auto": "Auto (med reserve)",
...
"close": "Zamknij",
"delete": "Usuń",
"selected": "Zaznaczono: %1$d",
"loading": "Ładowanie…",
"updated": "Zaktualizowano %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Błąd sieci",
"clear": "WYCZYŚĆ",
"add_currency": "＋ Dodaj walutę",
"mid_market": "Kursy mid-market ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "wer. %1$s",
"base_currency": "Waluta bazowa",
"delete_currency_title": "Usunąć walutę?",
"delete_currency_msg": "Usunąć %1$s — %2$s z listy?",
"add_currency_title": "Wybierz spośród %1$d dostępnych walut",
"search_hint": "Kod lub nazwa…",
"update_title": "Dostępna aktualizacja",
"update_msg": "Wersja %1$s jest dostępna. Pobrać i zainstalować?",
"update_now": "Aktualizuj",
"update_later": "Później",
"downloading": "Pobieranie…",
"settings": "Ustawienia",
"setting_precision": "Dokładność wyświetlania:  %1$s",
"setting_source": "Źródło kursów:  %1$s",
"setting_language": "🌐 Język:  %1$s",
"precision_title": "Dokładność wyświetlania",
"prec_0": "0 — liczby całkowite",
"prec_1": "1 miejsce dziesiętne",
"prec_2": "2 miejsca dziesiętne",
"prec_4": "4 miejsca dziesiętne",
"precision_value_int": "liczby całkowite",
"precision_value_n": "%1$d msc.",
"source_title": "Źródło kursów",
"source_auto": "Automatyczne (z rezerwą)",
"language_title": "Język",
"language_system": "Domyślny systemowy",
"source_info_title": "Źródło kursów",
"source_info_message": "Kurs mid-market — punkt środkowy między ceną kupna a sprzedaży na rynku globalnym.\n\nWaluta bazowa: EUR, pozostałe pary są obliczane przez euro.\n\nŹródła (automatyczna rezerwa):\n1. ExchangeRate-API — główne\n2. F.A. — gdy główne jest niedostępne\n3. Frankfurter (ECB) — druga rezerwa\n\nJeśli główne źródło nie odpowiada podczas automatycznej aktualizacji lub po ↻, aplikacja automatycznie pobiera dane z kolejnego. Bieżące źródło jest pokazane na górze obok czasu aktualizacji.\n\nW Ustawieniach (⚙) można wymusić konkretne źródło — pozostałe nadal działają jako rezerwa.\n\nAktualizacja raz dziennie. Różnica względem innych serwisów referencyjnych jest zwykle mniejsza niż 0.5% — są to kursy referencyjne, a nie notowania w czasie rzeczywistym.\n\nLicencje i atrybucja:\n• ExchangeRate-API — wymaga linku “Rates By Exchange Rate API” (w stopce, klikalny).\n• F.A. — CC0 (domena publiczna), atrybucja niewymagana.\n• Frankfurter — MIT, dane z European Central Bank (ECB).",
...
"close": "Fechar",
"delete": "Excluir",
"selected": "Selecionado: %1$d",
"loading": "Carregando…",
"updated": "Atualizado %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Erro de rede",
"clear": "LIMPAR",
"add_currency": "＋ Adicionar moeda",
"mid_market": "Taxas de mercado médio ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "ver. %1$s",
"base_currency": "Moeda base",
"delete_currency_title": "Remover moeda?",
"delete_currency_msg": "Remover %1$s — %2$s da lista?",
"add_currency_title": "Escolha entre %1$d moedas disponíveis",
"search_hint": "Código ou nome…",
"update_title": "Atualização disponível",
"update_msg": "A versão %1$s está disponível. Baixar e instalar?",
"update_now": "Atualizar",
"update_later": "Depois",
"downloading": "Baixando…",
"settings": "Configurações",
"setting_precision": "Precisão de exibição:  %1$s",
"setting_source": "Fonte das taxas:  %1$s",
"setting_language": "🌐 Idioma:  %1$s",
"precision_title": "Precisão de exibição",
"prec_0": "0 — inteiros",
"prec_1": "1 casa decimal",
"prec_2": "2 casas decimais",
"prec_4": "4 casas decimais",
"precision_value_int": "inteiros",
"precision_value_n": "%1$d dec.",
"source_title": "Fonte das taxas",
"source_auto": "Automático (com alternativa)",
"language_title": "Idioma",
"language_system": "Padrão do sistema",
"source_info_title": "Fonte das taxas",
"source_info_message": "Taxa de mercado médio — o ponto médio entre compra e venda no mercado global.\n\nMoeda base: EUR, os outros pares são calculados através do euro.\n\nFontes (alternativa automática):\n1. ExchangeRate-API — principal\n2. F.A. — se a principal estiver indisponível\n3. Frankfurter (ECB) — segunda alternativa\n\nSe a fonte principal não responder durante a atualização automática ou ao tocar em ↻, o app pega automaticamente os dados da próxima. A fonte atual é mostrada no topo, ao lado do horário de atualização.\n\nNas Configurações (⚙) você pode forçar uma fonte específica — as outras continuam como alternativa.\n\nAtualiza uma vez por dia. A diferença em relação a outros serviços de referência costuma ser inferior a 0.5% — são taxas de referência, não cotações em tempo real.\n\nLicenças e atribuição:\n• ExchangeRate-API — exige o link “Rates By Exchange Rate API” (no rodapé, clicável).\n• F.A. — CC0 (domínio público), sem atribuição necessária.\n• Frankfurter — MIT, dados do European Central Bank (ECB).",
"filter_all": "Todas",
...
"close": "Închide",
"delete": "Șterge",
"selected": "Selectate: %1$d",
"loading": "Se încarcă…",
"updated": "Actualizat %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Eroare de rețea",
"clear": "GOLEȘTE",
"add_currency": "＋ Adaugă valută",
"mid_market": "Cursuri medii de piață ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "ver. %1$s",
"base_currency": "Valută de bază",
"delete_currency_title": "Elimini valuta?",
"delete_currency_msg": "Elimini %1$s — %2$s din listă?",
"add_currency_title": "Alege din %1$d valute disponibile",
"search_hint": "Cod sau nume…",
"update_title": "Actualizare disponibilă",
"update_msg": "Versiunea %1$s este disponibilă. Descarci și instalezi?",
"update_now": "Actualizează",
"update_later": "Mai târziu",
"downloading": "Se descarcă…",
"settings": "Setări",
"setting_precision": "Precizie afișare:  %1$s",
"setting_source": "Sursa cursurilor:  %1$s",
"setting_language": "🌐 Limbă:  %1$s",
"precision_title": "Precizie afișare",
"prec_0": "0 — numere întregi",
"prec_1": "1 zecimală",
"prec_2": "2 zecimale",
"prec_4": "4 zecimale",
"precision_value_int": "numere întregi",
"precision_value_n": "%1$d zec.",
"source_title": "Sursa cursurilor",
"source_auto": "Automat (cu rezervă)",
"language_title": "Limbă",
"language_system": "Implicit din sistem",
"source_info_title": "Sursa cursurilor",
"source_info_message": "Curs mediu de piață — punctul de mijloc între cumpărare și vânzare pe piața globală.\n\nValută de bază: EUR, celelalte perechi se calculează prin euro.\n\nSurse (rezervă automată):\n1. ExchangeRate-API — principală\n2. F.A. — dacă principala nu funcționează\n3. Frankfurter (ECB) — a doua rezervă\n\nDacă sursa principală nu răspunde în timpul actualizării automate sau la ↻, aplicația preia automat datele de la următoarea. Sursa curentă este afișată sus, lângă ora actualizării.\n\nÎn Setări (⚙) poți impune o anumită sursă — celelalte rămân în continuare ca rezervă.\n\nSe actualizează o dată pe zi. Diferența față de alte servicii de referință este de obicei sub 0.5% — acestea sunt cursuri de referință, nu cotații în timp real.\n\nLicențe și atribuire:\n• ExchangeRate-API — necesită linkul “Rates By Exchange Rate API” (în subsol, pe care se poate face clic).\n• F.A. — CC0 (domeniu public), fără atribuire necesară.\n• Frankfurter — MIT, date de la Banca Centrală Europeană (ECB).",
"filter_all": "Toate",
...
"close": "Zavrieť",
"delete": "Odstrániť",
"selected": "Vybraté: %1$d",
"loading": "Načítava sa…",
"updated": "Aktualizované %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Chyba siete",
"clear": "VYMAZAŤ",
"add_currency": "＋ Pridať menu",
"mid_market": "Stredné trhové kurzy ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "ver. %1$s",
"base_currency": "Základná mena",
"delete_currency_title": "Odstrániť menu?",
"delete_currency_msg": "Odstrániť %1$s — %2$s zo zoznamu?",
"add_currency_title": "Vyberte z %1$d dostupných mien",
"search_hint": "Kód alebo názov…",
"update_title": "Dostupná aktualizácia",
"update_msg": "Verzia %1$s je dostupná. Stiahnuť a nainštalovať?",
"update_now": "Aktualizovať",
"update_later": "Neskôr",
"downloading": "Sťahovanie…",
"settings": "Nastavenia",
"setting_precision": "Presnosť zobrazenia:  %1$s",
"setting_source": "Zdroj kurzov:  %1$s",
"setting_language": "🌐 Jazyk:  %1$s",
"precision_title": "Presnosť zobrazenia",
"prec_0": "0 — celé čísla",
"prec_1": "1 desatinné miesto",
"prec_2": "2 desatinné miesta",
"prec_4": "4 desatinné miesta",
"precision_value_int": "celé čísla",
"precision_value_n": "%1$d des.",
"source_title": "Zdroj kurzov",
"source_auto": "Automaticky (so zálohou)",
"language_title": "Jazyk",
"language_system": "Predvolené systémom",
"source_info_title": "Zdroj kurzov",
"source_info_message": "Stredný trhový kurz — stred medzi nákupom a predajom na globálnom trhu.\n\nZákladná mena: EUR, ostatné páry sa počítajú cez euro.\n\nZdroje (automatická záloha):\n1. ExchangeRate-API — primárny\n2. F.A. — ak primárny nefunguje\n3. Frankfurter (ECB) — druhá záloha\n\nAk primárny zdroj počas automatickej aktualizácie alebo po ↻ neodpovedá, aplikácia automaticky prevezme údaje z ďalšieho. Aktuálny zdroj je zobrazený hore vedľa času aktualizácie.\n\nV Nastaveniach (⚙) môžete vynútiť konkrétny zdroj — ostatné stále zostávajú ako záloha.\n\nAktualizácia raz denne. Rozdiel oproti iným referenčným službám je zvyčajne pod 0.5% — ide o referenčné kurzy, nie kotácie v reálnom čase.\n\nLicencie a uvedenie zdroja:\n• ExchangeRate-API — vyžaduje odkaz “Rates By Exchange Rate API” (v päte, klikateľný).\n• F.A. — CC0 (voľné dielo), uvedenie zdroja nie je potrebné.\n• Frankfurter — MIT, údaje z European Central Bank (ECB).",
"filter_all": "Všetko",
...
"close": "Zapri",
"delete": "Izbriši",
"selected": "Izbrano: %1$d",
"loading": "Nalaganje…",
"updated": "Posodobljeno %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Napaka omrežja",
"clear": "POČISTI",
"add_currency": "＋ Dodaj valuto",
"mid_market": "Srednji tržni tečaji ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "razl. %1$s",
"base_currency": "Osnovna valuta",
"delete_currency_title": "Odstranim valuto?",
"delete_currency_msg": "Odstranim %1$s — %2$s s seznama?",
"add_currency_title": "Izberite med %1$d razpoložljivimi valutami",
"search_hint": "Koda ali ime…",
"update_title": "Na voljo je posodobitev",
"update_msg": "Na voljo je različica %1$s. Prenesem in namestim?",
"update_now": "Posodobi",
"update_later": "Pozneje",
"downloading": "Prenašanje…",
"settings": "Nastavitve",
"setting_precision": "Natančnost prikaza:  %1$s",
"setting_source": "Vir tečajev:  %1$s",
"setting_language": "🌐 Jezik:  %1$s",
"precision_title": "Natančnost prikaza",
"prec_0": "0 — cela števila",
"prec_1": "1 decimalka",
"prec_2": "2 decimalki",
"prec_4": "4 decimalke",
"precision_value_int": "cela števila",
"precision_value_n": "%1$d dec.",
"source_title": "Vir tečajev",
"source_auto": "Samodejno (z rezervo)",
"language_title": "Jezik",
"language_system": "Privzeto v sistemu",
"source_info_title": "Vir tečajev",
"source_info_message": "Srednji tržni tečaj — sredina med nakupnim in prodajnim tečajem na svetovnem trgu.\n\nOsnovna valuta: EUR, drugi pari se izračunajo prek evra.\n\nViri (samodejna rezerva):\n1. ExchangeRate-API — primarni\n2. F.A. — če primarni ne deluje\n3. Frankfurter (ECB) — druga rezerva\n\nČe se primarni vir med samodejno posodobitvijo ali ob ↻ ne odzove, aplikacija samodejno prevzame podatke iz naslednjega. Trenutni vir je prikazan na vrhu poleg časa posodobitve.\n\nV nastavitvah (⚙) lahko vsilite določen vir — drugi še vedno ostanejo kot rezerva.\n\nPosodablja se enkrat na dan. Razlika od drugih referenčnih storitev je običajno pod 0.5% — to so referenčni tečaji, ne cene v realnem času.\n\nLicence in navedba virov:\n• ExchangeRate-API — zahteva povezavo “Rates By Exchange Rate API” (v nogi, klikljiva).\n• F.A. — CC0 (javna last), navedba ni potrebna.\n• Frankfurter — MIT, podatki Evropske centralne banke (ECB).",
"filter_all": "Vse",
...
"close": "Mbyll",
"delete": "Fshi",
"selected": "Të zgjedhura: %1$d",
"loading": "Duke u ngarkuar…",
"updated": "Përditësuar %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Gabim rrjeti",
"clear": "PASTRO",
"add_currency": "＋ Shto monedhë",
"mid_market": "Kurse mesatare të tregut ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "ver. %1$s",
"base_currency": "Monedha bazë",
"delete_currency_title": "Të hiqet monedha?",
"delete_currency_msg": "Të hiqet %1$s — %2$s nga lista?",
"add_currency_title": "Zgjidhni nga %1$d monedha të disponueshme",
"search_hint": "Kodi ose emri…",
"update_title": "Përditësim i disponueshëm",
"update_msg": "Versioni %1$s është i disponueshëm. Të shkarkohet dhe instalohet?",
"update_now": "Përditëso",
"update_later": "Më vonë",
"downloading": "Duke u shkarkuar…",
"settings": "Cilësimet",
"setting_precision": "Saktësia e shfaqjes:  %1$s",
"setting_source": "Burimi i kursit:  %1$s",
"setting_language": "🌐 Gjuha:  %1$s",
"precision_title": "Saktësia e shfaqjes",
"prec_0": "0 — numra të plotë",
"prec_1": "1 dhjetore",
"prec_2": "2 dhjetore",
"prec_4": "4 dhjetore",
"precision_value_int": "numra të plotë",
"precision_value_n": "%1$d dhj.",
"source_title": "Burimi i kursit",
"source_auto": "Automatik (me rezervë)",
"language_title": "Gjuha",
"language_system": "Parazgjedhja e sistemit",
"source_info_title": "Burimi i kursit",
"source_info_message": "Kursi mesatar i tregut — pika e mesme midis blerjes dhe shitjes në tregun global.\n\nMonedha bazë: EUR, çiftet e tjera llogariten përmes euros.\n\nBurimet (rezervë automatike):\n1. ExchangeRate-API — kryesor\n2. F.A. — nëse kryesori nuk punon\n3. Frankfurter (ECB) — rezerva e dytë\n\nNëse burimi kryesor nuk përgjigjet gjatë përditësimit automatik ose në ↻, aplikacioni merr automatikisht të dhënat nga i ardhshmi. Burimi aktual shfaqet në krye pranë kohës së përditësimit.\n\nNë Cilësimet (⚙) mund të impononi një burim të caktuar — të tjerët përsëri mbeten si rezervë.\n\nPërditësohet një herë në ditë. Ndryshimi nga shërbime të tjera referimi zakonisht është nën 0.5% — këto janë kurse referimi, jo kuotime në kohë reale.\n\nLicencat dhe atribuimi:\n• ExchangeRate-API — kërkon lidhjen „Rates By Exchange Rate API“ (në fund, e klikueshme).\n• F.A. — CC0 (domen publik), pa atribuim të detyrueshëm.\n• Frankfurter — MIT, të dhëna nga Banka Qendrore Evropiane (ECB).",
...
"close": "Затвори",
"delete": "Обриши",
"selected": "Изабрано: %1$d",
"loading": "Учитавање…",
"updated": "Ажурирано %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Грешка мреже",
"clear": "ОБРИШИ",
"add_currency": "＋ Додај валуту",
"mid_market": "Средњи тржишни курсеви ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "верз. %1$s",
"base_currency": "Основна валута",
"delete_currency_title": "Уклонити валуту?",
"delete_currency_msg": "Уклонити %1$s — %2$s са листе?",
"add_currency_title": "Изаберите од %1$d доступних валута",
"search_hint": "Код или назив…",
"update_title": "Доступно ажурирање",
"update_msg": "Верзија %1$s је доступна. Преузети и инсталирати?",
"update_now": "Ажурирај",
"update_later": "Касније",
"downloading": "Преузимање…",
"settings": "Подешавања",
"setting_precision": "Приказана прецизност:  %1$s",
"setting_source": "Извор курса:  %1$s",
"setting_language": "🌐 Језик:  %1$s",
"precision_title": "Приказана прецизност",
"prec_0": "0 — цели бројеви",
"prec_1": "1 децимала",
"prec_2": "2 децимале",
"prec_4": "4 децимале",
"precision_value_int": "цели бројеви",
"precision_value_n": "%1$d дец.",
"source_title": "Извор курса",
"source_auto": "Аутоматски (са резервом)",
"language_title": "Језик",
"language_system": "Подразумевано системско",
"source_info_title": "Извор курса",
"source_info_message": "Средњи тржишни курс — средина између куповног и продајног на светском тржишту.\n\nОсновна валута: EUR, остали парови се рачунају преко евра.\n\nИзвори (аутоматска резерва):\n1. ExchangeRate-API — примарни\n2. F.A. — ако примарни не ради\n3. Frankfurter (ECB) — друга резерва\n\nАко примарни извор не одговори током аутоматског ажурирања или на ↻, апликација аутоматски узима податке од следећег. Тренутни извор је приказан на врху поред времена ажурирања.\n\nУ Подешавањима (⚙) можете наметнути одређени извор — остали и даље остају као резерва.\n\nАжурира се једном дневно. Разлика у односу на друге референтне сервисе је обично мања од 0.5% — то су референтни курсеви, а не котације у реалном времену.\n\nЛиценце и атрибуција:\n• ExchangeRate-API — захтева линк „Rates By Exchange Rate API“ (у подножју, кликабилан).\n• F.A. — CC0 (јавно власништво), без обавезне атрибуције.\n• Frankfurter — MIT, подаци из Европске централне банке (ECB).",
"filter_all": "Sve",
...
"selected": "Valda: %1$d",
"loading": "Laddar…",
"updated": "Uppdaterad %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Nätverksfel",
"clear": "RENSA",
"add_currency": "＋ Lägg till valuta",
"mid_market": "Mittmarknadskurser ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "ver. %1$s",
"base_currency": "Basvaluta",
"delete_currency_title": "Ta bort valuta?",
"delete_currency_msg": "Ta bort %1$s — %2$s från listan?",
"add_currency_title": "Välj bland %1$d tillgängliga valutor",
"search_hint": "Kod eller namn…",
"update_title": "Uppdatering tillgänglig",
"update_msg": "Version %1$s är tillgänglig. Ladda ner och installera?",
"update_now": "Uppdatera",
"update_later": "Senare",
"downloading": "Laddar ner…",
"settings": "Inställningar",
"setting_precision": "Visningsprecision:  %1$s",
"setting_source": "Kurskälla:  %1$s",
"setting_language": "🌐 Språk:  %1$s",
"precision_title": "Visningsprecision",
"prec_0": "0 — heltal",
"prec_1": "1 decimal",
"prec_2": "2 decimaler",
"prec_4": "4 decimaler",
...
"close": "ปิด",
"delete": "ลบ",
"selected": "เลือกแล้ว: %1$d",
"loading": "กำลังโหลด…",
"updated": "อัปเดต %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "เครือข่ายผิดพลาด",
"clear": "ล้าง",
"add_currency": "＋ เพิ่มสกุลเงิน",
"mid_market": "อัตรากลางตลาด ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "เวอร์ชัน %1$s",
"base_currency": "สกุลเงินฐาน",
"delete_currency_title": "นำสกุลเงินออก?",
"delete_currency_msg": "นำ %1$s — %2$s ออกจากรายการ?",
"add_currency_title": "เลือกจากสกุลเงินที่มี %1$d รายการ",
"search_hint": "รหัสหรือชื่อ…",
"update_title": "มีอัปเดตใหม่",
"update_msg": "เวอร์ชัน %1$s พร้อมใช้งาน ดาวน์โหลดและติดตั้งเลยไหม?",
"update_now": "อัปเดต",
"update_later": "ภายหลัง",
"downloading": "กำลังดาวน์โหลด…",
"settings": "การตั้งค่า",
"setting_precision": "ความละเอียดที่แสดง:  %1$s",
"setting_source": "แหล่งอัตรา:  %1$s",
"setting_language": "🌐 ภาษา:  %1$s",
"precision_title": "ความละเอียดที่แสดง",
"prec_0": "0 — จำนวนเต็ม",
"prec_1": "ทศนิยม 1 ตำแหน่ง",
"prec_2": "ทศนิยม 2 ตำแหน่ง",
"prec_4": "ทศนิยม 4 ตำแหน่ง",
"precision_value_int": "จำนวนเต็ม",
"precision_value_n": "%1$d ตำแหน่ง",
"source_title": "แหล่งอัตรา",
"source_auto": "อัตโนมัติ (มีตัวสำรอง)",
"language_title": "ภาษา",
"language_system": "ค่าเริ่มต้นของระบบ",
"source_info_title": "แหล่งอัตรา",
"source_info_message": "อัตรากลางตลาด — จุดกึ่งกลางระหว่างราคาซื้อและขายในตลาดโลก\n\nสกุลเงินฐาน: EUR ส่วนคู่อื่น ๆ คำนวณผ่านยูโร\n\nแหล่งข้อมูล (สลับสำรองอัตโนมัติ):\n1. ExchangeRate-API — หลัก\n2. F.A. — เมื่อแหล่งหลักใช้งานไม่ได้\n3. Frankfurter (ECB) — ตัวสำรองที่สอง\n\nหากแหล่งหลักไม่ตอบสนองระหว่างการอัปเดตอัตโนมัติหรือเมื่อกด ↻ แอปจะดึงข้อมูลจากแหล่งถัดไปให้อัตโนมัติ แหล่งที่ใช้อยู่จะแสดงด้านบนถัดจากเวลาอัปเดต\n\nในการตั้งค่า (⚙) คุณสามารถบังคับใช้แหล่งใดแหล่งหนึ่งได้ — แหล่งอื่นยังคงเป็นตัวสำรอง\n\nอัปเดตวันละครั้ง ความต่างจากบริการอ้างอิงอื่นมักน้อยกว่า 0.5% — นี่คืออัตราอ้างอิง ไม่ใช่ราคาแบบเรียลไทม์\n\nสัญญาอนุญาตและการให้เครดิต:\n• ExchangeRate-API — ต้องมีลิงก์ “Rates By Exchange Rate API” (อยู่ด้านล่าง คลิกได้)\n• F.A. — CC0 (สาธารณสมบัติ) ไม่ต้องให้เครดิต\n• Frankfurter — MIT ข้อมูลจากธนาคารกลางยุโรป (ECB)",
"filter_all": "ทั้งหมด",
...
"close": "Đóng",
"delete": "Xóa",
"selected": "Đã chọn: %1$d",
"loading": "Đang tải…",
"updated": "Cập nhật %1$s · %2$s",
"error_prefix": "⚠ %1$s",
"network_error": "Lỗi mạng",
"clear": "XÓA",
"add_currency": "＋ Thêm tiền tệ",
"mid_market": "Tỷ giá trung bình ⓘ",
"attribution": "Rates By Exchange Rate API",
"version": "phiên bản %1$s",
"base_currency": "Tiền tệ cơ sở",
"delete_currency_title": "Gỡ tiền tệ?",
"delete_currency_msg": "Gỡ %1$s — %2$s khỏi danh sách?",
"add_currency_title": "Chọn từ %1$d loại tiền tệ có sẵn",
"search_hint": "Mã hoặc tên…",
"update_title": "Có bản cập nhật",
"update_msg": "Đã có phiên bản %1$s. Tải xuống và cài đặt?",
"update_now": "Cập nhật",
"update_later": "Để sau",
"downloading": "Đang tải xuống…",
"settings": "Cài đặt",
"setting_precision": "Độ chính xác hiển thị:  %1$s",
"setting_source": "Nguồn tỷ giá:  %1$s",
"setting_language": "🌐 Ngôn ngữ:  %1$s",
"precision_title": "Độ chính xác hiển thị",
"prec_0": "0 — số nguyên",
"prec_1": "1 chữ số thập phân",
"prec_2": "2 chữ số thập phân",
"prec_4": "4 chữ số thập phân",
"precision_value_int": "số nguyên",
"precision_value_n": "%1$d chữ số",
"source_title": "Nguồn tỷ giá",
"source_auto": "Tự động (có dự phòng)",
"language_title": "Ngôn ngữ",
"language_system": "Mặc định hệ thống",
"source_info_title": "Nguồn tỷ giá",
"source_info_message": "Tỷ giá trung bình — điểm giữa giữa giá mua và giá bán trên thị trường toàn cầu.\n\nTiền tệ cơ sở: EUR, các cặp khác được tính qua đồng euro.\n\nNguồn (tự động dự phòng):\n1. ExchangeRate-API — chính\n2. F.A. — khi nguồn chính không hoạt động\n3. Frankfurter (ECB) — dự phòng thứ hai\n\nNếu nguồn chính không phản hồi khi tự động cập nhật hoặc khi nhấn ↻, ứng dụng sẽ tự lấy dữ liệu từ nguồn tiếp theo. Nguồn hiện tại hiển thị ở trên cùng, bên cạnh thời gian cập nhật.\n\nTrong Cài đặt (⚙) bạn có thể buộc dùng một nguồn cụ thể — các nguồn còn lại vẫn làm dự phòng.\n\nCập nhật mỗi ngày một lần. Chênh lệch so với các dịch vụ tham chiếu khác thường dưới 0.5% — đây là tỷ giá tham chiếu, không phải báo giá thời gian thực.\n\nGiấy phép và ghi công:\n• ExchangeRate-API — yêu cầu liên kết “Rates By Exchange Rate API” (ở chân trang, có thể nhấp).\n• F.A. — CC0 (phạm vi công cộng), không cần ghi công.\n• Frankfurter — MIT, dữ liệu từ Ngân hàng Trung ương châu Âu (ECB).",
"filter_all": "Tất cả",
...
"version": "版本 %1$s",
"base_currency": "基准货币",
"delete_currency_title": "移除货币？",
"delete_currency_msg": "从列表中移除 %1$s — %2$s？",
"add_currency_title": "从 %1$d 种可用货币中选择",
"search_hint": "代码或名称…",
"update_title": "有可用更新",
"update_msg": "有可用版本 %1$s。下载并安装？",
"update_now": "更新",
"update_later": "稍后",
"downloading": "下载中…",
"settings": "设置",
"setting_precision": "显示精度：  %1$s",
"setting_source": "汇率来源：  %1$s",
"setting_language": "🌐 语言：  %1$s",
"precision_title": "显示精度",
"prec_0": "0 — 整数",
"prec_1": "1 位小数",
"prec_2": "2 位小数",
"prec_4": "4 位小数",
"precision_value_int": "整数",
"precision_value_n": "%1$d 位小数",
"source_title": "汇率来源",
"source_auto": "自动（含备用）",
"language_title": "语言",
"language_system": "系统默认",
"source_info_title": "汇率来源",
"source_info_message": "中间市场汇率 — 全球市场买入与卖出的中点。\n\n基准货币：EUR，其他货币对通过欧元换算。\n\n来源（自动备用）：\n1. ExchangeRate-API — 主要\n2. F.A. — 主要来源不可用时\n3. Frankfurter (ECB) — 第二备用\n\n如果在自动更新或点击 ↻ 时主要来源无响应，应用会自动从下一个来源获取数据。当前来源显示在顶部更新时间旁边。\n\n在设置（⚙）中，你可以强制指定某个来源 — 其他来源仍作为备用。\n\n每天更新一次。与其他参考服务的差异通常小于 0.5% — 这些是参考汇率，而非实时报价。\n\n许可与署名：\n• ExchangeRate-API — 需要“Rates By Exchange Rate API”链接（位于页脚，可点击）。\n• F.A. — CC0（公共领域），无需署名。\n• Frankfurter — MIT，数据来自欧洲中央银行 (ECB)。",
"filter_all": "全部",
